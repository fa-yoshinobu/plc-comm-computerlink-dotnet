...
- The requested device is outside the range supported by your specific TOYOPUC model. Refer to the `ToyopucPlcProfiles` class or the User Guide for supported ranges per model.
