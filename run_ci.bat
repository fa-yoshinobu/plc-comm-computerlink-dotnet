...
echo [4/4] Publishing DeviceMonitor...
dotnet publish examples\PlcComm.Toyopuc.DeviceMonitor\PlcComm.Toyopuc.DeviceMonitor.csproj -c Release -r win-x64 --self-contained true /p:PublishSingleFile=true /p:PublishReadyToRun=true /p:PublishTrimmed=false -o "%PUBLISH_DIR%\DeviceMonitor"
