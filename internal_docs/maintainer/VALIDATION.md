...
- Use [PlcComm.Toyopuc.SmokeTest](../../examples/PlcComm.Toyopuc.SmokeTest/Program.cs) for general validation runs.
- Use [PlcComm.Toyopuc.BitPatternProbe](../../examples/PlcComm.Toyopuc.BitPatternProbe/Program.cs) for sampled `BIT -> W/L/H` readback validation.
