...
namespace PlcComm.Toyopuc.Examples;
...
internal static class OperationalCommon
{
    ...
    public static ToyopucTransportMode ParseTransport(string value)
        => Enum.Parse<ToyopucTransportMode>(value, ignoreCase: true);

    public static string TransportLabel(ToyopucTransportMode transport)
    ...
    public static TagSpec DefaultTag() => ParseTagSpec("P1-D0100:U");
